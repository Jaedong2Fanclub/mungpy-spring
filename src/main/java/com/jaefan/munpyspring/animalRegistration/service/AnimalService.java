package com.jaefan.munpyspring.animalRegistration.service;
...
import com.jaefan.munpyspring.animalRegistration.model.AnimalImage;
import com.jaefan.munpyspring.animalRegistration.model.Breed;
import com.jaefan.munpyspring.animalRegistration.repository.AnimalRepository;
import com.jaefan.munpyspring.s3.S3Uploader;
...
public class AnimalService {
	...
	public void regist(AnimalRegistRequestDto animalRegistRequestDto) throws IOException {
		...
		animal.setAnimalImages(animalImages); // setter로 동물 엔티티에 이미지 추가. (Cascade.ALL로 인해 Animal 저장 시 AnimalImage도 일괄 저장됨)
